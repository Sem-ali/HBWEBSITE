...
<head>
    ...
    <title>My Hotel Website - ROOMS</title>
</head>
<body class="bg-light">
 ...
 <div class="container">
  <div class="row">
    <div class="col-lg-3 col-md-12 mb-lg-0 mb-4 px-lg-0">
     <nav class="navbar navbar-expand-lg bg-white navbar-light bg-white rounded shadow">
      ...
      <div class="collapse navbar-collapse flex-column align-items-stretch mt-2" id="filterDropdown">
        ...
        <div class="border bg-light p-3 rounded mb-1">
            <h5 class="mb-3" style="font-size:16px">OTHERS</h5>
            <div class="d-flex">
                <div class="me-2">
 ...
 <div class="col-lg-9 col-md-12 px-4">
    ...
    <div class="row g-0 p-3 align-items-center">
      <div class="col-md-5 mb-lg-0 mb-md-0 mb-3">
      <img src="images/Rooms/Room3.png" class="img-fluid rounded">
      </div>
       <div class="col-md-5 px-lg-3 px-md-3 px-0">
        <h5 class="mb-3">Simple Room Name</h5>
        <div class="features mb-4">
    ...
    <div class="row g-0 p-3 align-items-center">
      <div class="col-md-5 mb-lg-0 mb-md-0 mb-3">
      <img src="images/Rooms/Room4.png" class="img-fluid rounded">
      </div>
       <div class="col-md-5 px-lg-3 px-md-3 px-0">
        <h5 class="mb-3">Simple Room Name</h5>
        <div class="features mb-4">
